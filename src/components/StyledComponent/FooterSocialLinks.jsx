...
const FooterSocialLinks = () => {
     const socialLinks = {
    instagram: "https://www.instagram.com/__balram__rajbanshi__/",
    linkedin: "https://www.linkedin.com/in/balram-rajbanshi-5079ab276/",
    github: "https://github.com/BalramRajbanshi69"
  };
  return (
    <StyledWrapper>
      <div className="social-login-icons">
        ...
        <div className="socialcontainer">
          ...
          <div className="icon social-icon-3-3">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="white" height="1.6em">
